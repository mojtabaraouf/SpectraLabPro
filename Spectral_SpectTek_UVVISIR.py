...
CO2 and H2O tracer windows from 200–2500 nm, external CSV import, manual X/Y
...
# Main CO2/H2O tracers from 200 to 2500 nm.
# Optical/UV tracers are mostly indirect; SWIR bands are mostly direct absorption.
TRACERS: List[TracerFeature] = [
    # ---------------- UV/VIS: H2O indirect and weak direct ----------------
    TracerFeature("H2O", "OH A-X band", "emission", 308.5, 2.5, (300.0, 305.0), (312.0, 317.0),
                  "Indirect H2O tracer: OH from H2O photodissociation.", "tab:blue"),
    TracerFeature("H2O", "OH+ band", "emission", 335.0, 3.0, (326.0, 331.0), (339.0, 344.0),
                  "Ionized water-chemistry tracer in near-UV.", "tab:cyan"),
    TracerFeature("H2O", "H2O UV absorption", "absorption", 363.0, 8.0, (345.0, 355.0), (372.0, 382.0),
                  "Weak/broad near-UV H2O absorption region.", "tab:purple"),
    TracerFeature("H2O", "[O I] green", "forbidden", 557.7, 1.5, (552.0, 555.0), (560.0, 563.0),
                  "Oxygen forbidden line; indirect H2O/OH photodissociation tracer.", "tab:green"),
    TracerFeature("H2O/CO2", "[O I] red 6300", "forbidden", 630.0, 1.5, (624.0, 627.0), (633.0, 636.0),
                  "Oxygen forbidden line; can trace H2O, CO2, or CO photochemistry.", "tab:red"),
    TracerFeature("H2O/CO2", "[O I] red 6364", "forbidden", 636.4, 1.5, (631.0, 634.0), (640.0, 643.0),
                  "Oxygen forbidden companion line.", "tab:pink"),

    # ---------------- UV/VIS: CO2 indirect/ion tracers ----------------
    TracerFeature("CO2", "CO Cameron band", "band", 240.0, 40.0, (200.0, 210.0), (272.0, 280.0),
                  "CO Cameron bands, often linked to CO2/CO photochemistry.", "tab:gray"),
    TracerFeature("CO2", "C I 247.9", "emission", 247.9, 1.5, (242.0, 245.0), (251.0, 254.0),
                  "Atomic carbon line; indirect carbon-bearing gas tracer.", "tab:olive"),
    TracerFeature("CO2", "CO2+ UV doublet 1", "emission", 288.3, 1.2, (284.0, 286.5), (290.5, 293.0),
                  "CO2+ near-UV ion tracer.", "tab:orange"),
    TracerFeature("CO2", "CO2+ UV doublet 2", "emission", 289.6, 1.2, (285.0, 287.0), (292.0, 294.0),
                  "Second CO2+ UV doublet component.", "tab:orange"),
    TracerFeature("CO2", "CO2+ FDB band", "band", 325.0, 15.0, (300.0, 308.0), (342.0, 350.0),
                  "Fox-Duffendack-Barker CO2+ band system, broadly 310–340 nm.", "tab:brown"),
    TracerFeature("CO2", "C I 872.7", "emission", 872.7, 2.0, (865.0, 869.0), (876.0, 880.0),
                  "Red/near-IR atomic carbon line.", "tab:olive"),

    # ---------------- SWIR: H2O direct absorption bands ----------------
    TracerFeature("H2O", "H2O 940 nm band", "absorption", 940.0, 18.0, (900.0, 915.0), (970.0, 985.0),
                  "Direct/strong water vapor absorption band near 940 nm.", "tab:blue"),
    TracerFeature("H2O", "H2O 970 nm band", "absorption", 970.0, 18.0, (930.0, 945.0), (1000.0, 1015.0),
                  "Water absorption overtone band near 970 nm.", "tab:blue"),
    TracerFeature("H2O", "H2O 1130 nm band", "absorption", 1130.0, 30.0, (1065.0, 1090.0), (1180.0, 1210.0),
                  "Direct water vapor absorption band near 1130 nm.", "tab:cyan"),
    TracerFeature("H2O", "H2O 1370 nm band", "absorption", 1370.0, 45.0, (1280.0, 1310.0), (1450.0, 1480.0),
                  "Strong direct water vapor absorption band near 1370–1400 nm.", "tab:purple"),
    TracerFeature("H2O", "H2O 1450 nm band", "absorption", 1450.0, 45.0, (1350.0, 1380.0), (1520.0, 1550.0),
                  "Strong water absorption band near 1450 nm.", "tab:purple"),
    TracerFeature("H2O", "H2O 1870 nm band", "absorption", 1870.0, 55.0, (1760.0, 1800.0), (1950.0, 1990.0),
                  "Strong SWIR water vapor absorption band near 1870–1900 nm.", "tab:blue"),
    TracerFeature("H2O", "H2O 1950 nm band", "absorption", 1950.0, 60.0, (1820.0, 1860.0), (2020.0, 2060.0),
                  "Strong water absorption near 1950 nm.", "tab:blue"),

    # ---------------- SWIR: CO2 direct absorption bands ----------------
    TracerFeature("CO2", "CO2 1437 nm band", "absorption", 1437.0, 18.0, (1390.0, 1410.0), (1470.0, 1490.0),
                  "Near-IR CO2 absorption feature around 1437 nm.", "tab:orange"),
    TracerFeature("CO2", "CO2 1570 nm band", "absorption", 1570.0, 20.0, (1515.0, 1540.0), (1605.0, 1630.0),
                  "Important CO2 column/sensing band near 1570–1580 nm.", "tab:orange"),
    TracerFeature("CO2", "CO2 1600 nm band", "absorption", 1600.0, 28.0, (1525.0, 1550.0), (1650.0, 1680.0),
                  "CO2 near-IR absorption complex around 1.6 µm.", "tab:brown"),
    TracerFeature("CO2", "CO2 1955 nm band", "absorption", 1955.0, 22.0, (1900.0, 1925.0), (1995.0, 2020.0),
                  "CO2 near-IR absorption peak around 1955 nm.", "tab:red"),
    TracerFeature("CO2", "CO2 2013 nm band", "absorption", 2013.0, 25.0, (1950.0, 1975.0), (2050.0, 2075.0),
                  "CO2 SWIR absorption near 2013 nm.", "tab:red"),
    TracerFeature("CO2", "CO2 2060 nm band", "absorption", 2060.0, 30.0, (1990.0, 2015.0), (2110.0, 2140.0),
                  "CO2 band near 2.06 µm, widely used in CO2 remote sensing.", "tab:red"),
    TracerFeature("CO2", "CO2 2350 nm band", "absorption", 2350.0, 45.0, (2250.0, 2290.0), (2420.0, 2460.0),
...
class SpectraLabDualRangeSuite:
    def __init__(self, root):
        self.root = root
        self.root.title("SpectraLab Dual Spectrometer Suite — UV/VIS + SWIR CO2/H2O")
    ...
    def setup_ui(self):
        ...
        ttk.Label(top_bar, text="CO₂ / H₂O tracers: 200–2500 nm", foreground="gray").pack(side="left", padx=14)
    ...
    def _build_left(self, parent):
        ...
        tabs.add(tracer_tab, text="Tracers")
        ...
        sp_combo = ttk.Combobox(row2, textvariable=self.selected_species,
                                values=["All", "H2O", "CO2", "H2O/CO2"], state="readonly", width=10)
        ...
        ttk.Button(trac, text="Measure Feature", command=self.measure_selected_feature).pack(fill="x", pady=2)
        ...
        diagnostics_text = (
          "UV/VIS range, 200–900 nm:\\n"
          "• H₂O: OH 308–309 nm, OH⁺ near 335 nm, [O I] 557.7, 630.0, 636.4 nm.\\n"
          "• CO₂: CO Cameron 200–280 nm, CO₂⁺ 288–340 nm, C I 247.9 and 872.7 nm.\\n\\n"

          "SWIR range, 900–2500 nm:\\n"
          "• H₂O: direct absorption near 940, 970, 1130, 1370–1450, 1870, 1950 nm.\\n"
          "• CO₂: direct absorption near 1437, 1570–1600, 1955–2060, and 2350 nm.\\n\\n"

        "Use dark subtraction, reference spectra, wavelength calibration, "
        "and line/band ratios for quantitative gas measurements."
        )
    ...
    def _build_right(self, parent):
        ...
        self.xstart_var = tk.StringVar(value="200")
        ...
        ttk.Button(controls, text="200–900", command=lambda: self.set_range(200, 900)).pack(side="left", padx=1)
        ttk.Button(controls, text="900–2500", command=lambda: self.set_range(900, 2500)).pack(side="left", padx=1)
        ttk.Button(controls, text="Full", command=lambda: self.set_range(200, 2500)).pack(side="left", padx=1)
    ...
    def _init_axes(self):
        self.ax.set_title("Dual Spectrometer Spectrum with CO₂/H₂O Tracer Windows", fontsize=14, fontweight="bold")
    ...
    def start_plotter(self):
        def plot():
            ...
            if redraw:
                self.ax.cla()
                self.ax.grid(True, alpha=0.3, linestyle="--")
                self.ax.set_title("Dual UV/VIS + SWIR Spectrum with CO₂/H₂O Tracers", fontsize=14, fontweight="bold")
                self.ax.set_xlabel("Wavelength (nm)")
